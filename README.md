...
### Lists
Our database of songs is a list. We made a csv file and you can find the code [here](songs.csv).

### Procedures
Each procedure in main.py renders a corresponding .html file. Different routes are used and can be redirected on our webiste. Find the code [here](main.py).
